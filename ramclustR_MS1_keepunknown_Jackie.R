...
source("R:/Group Members/Jacqueline Chaparro/WorkFlow/server.functions.R")
...
#load("datasets0.20/RCobject_2_QCpostclustering.Rdata")
# before running do.findmain, load and run do.findmain.R to load in the most updated function

library(InterpretMSSpectrum) #make sure this is the most updated version

#val starting here 08112023

load("datasets0.20/RCobject_2_QCpostclusteringTICnormMergeClusters.Rdata")
